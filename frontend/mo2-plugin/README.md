...
`manageProfile` accepts `create`, `copy`, `rename` and `remove`. Create invokes
the original manager’s Create button and leaves ProfileInputDialog to MO2. Rename selects the
